...
export default function Camera({ onCapture, title = 'Measure Room', mode = 'measure' }) {
  ...
  // Fallback UI for PC testing
  if (!isARSupported) {
    return (
      <div className="camera-container" style={{ width: '100vw', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <p>{error}</p>
      </div>
    );
  }
